...
class Message:
    ...
    def add_message(self,params):
        ...
        resp=Request().get_json(url,test_params=params,test_headers=self.headers)
        return resp

    def get_message(self):
        url = base_url + 'api/messages/1/4'
        resp=Request().get_json(url,test_headers=self.headers,request_type=RequestType.get)
        return resp
    ...
    def replay_message(self,params):
        ...
        # print(params)
        resp=Request().get_json(url,params,self.headers)
        return resp
